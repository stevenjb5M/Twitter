  ...
  return (
    <Routes>
      <Route element={<MainLayout />}>
        ...
        <Route path="feed/:displayedUser" element={<StatusItemScroller key={`feed-${displayedUser!.alias}`} featureUrl="/feeds" presenterFactory={(view: StatusItemView) => new FeedPresenter(view)} />} />
